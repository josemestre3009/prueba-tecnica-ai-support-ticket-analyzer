...
TEAM_BY_CATEGORY = {
    ...
    "Network": "Soporte Técnico",
    "Other": "Soporte Técnico",
    "Billing": "Facturación",
...
async def analyze_ticket(ticket_data: dict) -> dict:
    ...
    return {
        ...
        "summary": summary,
        "sentiment": sentiment,
        "responsible_team": TEAM_BY_CATEGORY.get(category, "Soporte Técnico"),
    }


async def ask_question(question: str, knowledge_base: str, tickets_context: str, _schema: str = "") -> str:
    return (
